...
namespace PragueParking2._0
{
    ...
    class Program
    {
        ...
        public static void ShowParkingLotList()
        {
            ...
            foreach (ParkingSpot pspot in ParkingLot)
            {
                ...
                if (pspot.FreeSpace != Program.config.ParkingSpotsAmount)
                {
                    ...
                    {
                        float charge = pspot.calculateCharge(pspot.findIndexOfVehicle(vehicle.Token));
        ...
        public static void renderParkingOverview(List<ParkingSpot> parkingLot)
        {
            ...
            Console.Write("    ");
            Console.ResetColor();
            Console.Write("  Occupied by one bicycle: ");
            Console.BackgroundColor = ConsoleColor.DarkGreen;
            Console.Write("    ");
            Console.ResetColor();
            Console.Write("  Occupied by one MC or two bicycles: ");
            Console.BackgroundColor = ConsoleColor.Blue;
            Console.Write("    ");
            Console.ResetColor();
            Console.Write("  Occupied by one MC and one bicycle or three bicycles: ");
